    ...
    <Container className="fade-in">
      ...
      <Grid container spacing={2} sx={{ mb: { xs: 2, md: 4 } }}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            ...
            <Typography variant="body2">
              Update and manage your existing listings to ensure they remain
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            ...
            <Typography variant="body2">
              Browse our extensive collection of flats to find the perfect home
              for you.
            </Typography>
          </Box>
        </Grid>
        ...
        <Box sx={{ textAlign: "center", mb: { xs: 2, md: 4 } }}>
          <Button
            ...
            sx={{
              ...
              padding: { xs: "0.5rem 1.5rem", md: "1rem 3rem" },
              margin: "0 10px",
            }}
          >
            View Flats
      ...
      >
        ...
        <Typography variant="body2" sx={{ fontSize: { xs: "0.8rem", md: "1rem" } }}>
          FlatFinder helped me find my perfect home! The process was smooth and
          easy.
        </Typography>
        <Typography
          variant="body2"
          sx={{ fontStyle: "italic", mt: 1, fontSize: { xs: "0.8rem", md: "1rem" } }}
        >
          - Satisfied User
        </Typography>
      </Box>
